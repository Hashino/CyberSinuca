  ...
  return (
    <div className="flex w-full items-center gap-2 border-b border-gray-2 bg-gray-1 px-2 py-2 text-gray-3 dark:bg-dark-2 dark:text-gray-1">
      <div className="flex w-full items-center gap-2">
        <span className="h-8 w-8 overflow-hidden rounded-md border-2 border-green bg-gray-3 font-extralight">
          {match.winner.imgUrl && (
            <img
      ...
      <div className="flex w-full items-center justify-end gap-2">
        ...
        <span className="h-8 w-8 overflow-hidden rounded-md border-2 border-red bg-gray-3 font-extralight">
          {match.loser.imgUrl && (
            <img
              className="h-full w-full object-cover"

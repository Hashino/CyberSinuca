...
const MatchInfoSelection: React.FC<MatchInfoSelectionProps> = ({ matchType, setMatchType }) => {
  return (
    <div className="w-full">
      <RadioGroup value={matchType} onChange={setMatchType} aria-label="Match type">
